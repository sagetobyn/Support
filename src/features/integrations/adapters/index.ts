import type { IntegrationAdapter, SourceType } from "../types";
...
const registry: Record<SourceType, IntegrationAdapter> = {
...
export function getAdapter(type: SourceType): IntegrationAdapter {
